...
class DataArguments:
    ...
    has_split: Optional[bool] = field(
        default=None,
        metadata={"help": "For situations where the test set and validation set have already been divided."}
    )
    split_index: Optional[int] = field(
        default=None,
        metadata={"help": "the split index of training and validation set"}
    )
