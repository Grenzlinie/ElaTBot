...
if __name__ == "__main__":
    ...
    with open("after_deleted_data.json", "w") as file:
        json.dump(data, file)
    ...
    with open('ec_desc_train_dataset_with_mpid.json', 'w') as file:
        json.dump(trmpid, file)

    with open('ec_desc_test_dataset_with_mpid.json', 'w') as file:
